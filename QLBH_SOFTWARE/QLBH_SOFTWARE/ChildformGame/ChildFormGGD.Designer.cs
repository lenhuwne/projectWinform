namespace QLBH_SOFTWARE
{
    partial class ChildFormGGD
    {
        ...
        private void InitializeComponent()
        {
            ...
            listGameGD = new ListView();
            imageGameGD = new ImageList(components);
            ...
            // listGameGD
            // 
            listGameGD.Dock = DockStyle.Fill;
            listGameGD.LargeImageList = imageGameGD;
            listGameGD.Location = new Point(0, 51);
            listGameGD.Name = "listGameGD";
            listGameGD.Size = new Size(1053, 571);
            listGameGD.TabIndex = 3;
            listGameGD.UseCompatibleStateImageBehavior = false;
            // 
            // imageGameGD
            // 
            imageGameGD.ColorDepth = ColorDepth.Depth8Bit;
            imageGameGD.ImageSize = new Size(150, 150);
            imageGameGD.TransparentColor = Color.Transparent;
            // 
            // ChildFormGGD
            // 
        ...
        private ListView listGameGD;
        private ImageList imageGameGD;
    }
}